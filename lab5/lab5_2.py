...
if __name__ == "__main__":
    ...
    width = 100; height = 100; temporal_dim = 100; nb_class = len(class_index); batch_size = 10; nb_epoch = 5
    random.seed(1)
    ...
    model.fit_generator(train_generator, epochs=nb_epoch, verbose=1, validation_data=test_generator)
